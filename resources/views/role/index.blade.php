                ...
                <nav class="navbar navbar-expand-lg card-header">
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <button class="btn btn-outline-success my-2 my-sm-0" type="submit" 
                            onclick="location.href='{{ route('role.create') }}'">Nuevo Rol
                        </button>
                        <div class="ml-5">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="dd-nodrag btn-group ml-auto">
                                                ...
                                                <button class="btn btn-sm btn-outline-light" data-toggle="tooltip" data-placement="top" title="Eliminar" id="stsCollab{{ $role->id }}" onclick="return delet({{$role->id}}, event)">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Deseas eliminar al rol</p>
            </div>
            <div class="modal-footer">
                <form id="validationformActive" action="{{ url('role/delete') }}" method="POST" data-parsley-validate="">
                    @csrf
