...
<div class="row">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="page-header">
            <h2 class="pageheader-title"> Actualizar Rol {{ $role['name'] }} </h2>
                ...
                <form id="validationform" action="{{ route('role.store') }}" method="POST" enctype="multipart/form-data" data-parsley-validate="" novalidate="">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-12 col-sm-8 col-lg-6">
                            <input id="name" name="name" type="text" value="{{ $role['name'] }}" placeholder="Nombre del rol" class="form-control @error('name') is-invalid @enderror">
                        </div>
                        @error('name')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-12 col-sm-8 col-lg-6">
                            <input id="code" name="code" type="text" value="{{ $role['code'] }}" placeholder="Nombre del rol" class="form-control" requiered>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-12 col-sm-8 col-lg-6">
                            <textarea name="description" placeholder="Descripción del rol" class="form-control @error('description') is-invalid @enderror">{{ $role['description'] }}</textarea>
                            @error('description')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
