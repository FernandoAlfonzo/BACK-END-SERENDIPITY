...
<div class="justify-content-center">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card m-0 justify-content-center">
            <div class="card-body">
                <form id="form" data-parsley-validate="" method="POST" enctype="multipart/form-data" action="{{ route('organizations.store') }}">
                    @csrf
                    <div class="form-group row">
                        <label class="col-3 col-lg-2 col-form-label text-right">Nombre comercial</label>
                        <div class="col-9 col-lg-10">
                            <input id="name_commercial" name="name_commercial" type="text" required data-parsley-type="text" placeholder="Nombre comercial" class="form-control">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-3 col-lg-2 col-form-label text-right">Razón social</label>
                        <div class="col-9 col-lg-10">
                            <input id="name_business" name="name_business" type="text" required data-parsley-type="text" placeholder="Razón social" class="form-control">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-3 col-lg-2 col-form-label text-right">Direccón</label>
                        <div class="col-9 col-lg-10">
                            <input id="address" name="address" type="text" required data-parsley-type="text" placeholder="Direccón" class="form-control">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-3 col-lg-2 col-form-label text-right">RFC</label>
                        <div class="col-9 col-lg-10">
                            <input id="RFC" name="RFC" type="text" required data-parsley-type="text" placeholder="RFC" class="form-control">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-3 col-lg-2 col-form-label text-right">Teléfono</label>
                        <div class="col-3 col-lg-4">
                            <input id="phone" name="phone" type="tel" required data-parsley-type="text" placeholder="Teléfono" class="form-control">
                        </div>

                        <label class="col-3 col-lg-2 col-form-label text-right">Correo</label>
                        <div class="col-3 col-lg-4">
                            <input id="email" name="email" type="email" required data-parsley-type="text" placeholder="Correo" class="form-control">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-3 col-lg-2 col-form-label text-right">Redes Sociales</label>
                        <div class="col-9 col-lg-10">
                            <textarea name="social_networks" id="social_networks" rows="5" cols="10" placeholder="Redes Sociales" class="form-control"></textarea>
                        </div>
                    </div>
