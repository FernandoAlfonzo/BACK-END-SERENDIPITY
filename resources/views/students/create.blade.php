...
<div class="row">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="page-header">
            <h2 class="pageheader-title"> Registrar AlumnoSS </h2>
            ...
            <div class="tab-content" id="myTabContent">
                ...
                <div class="tab-pane fade" id="address" role="tabpanel" aria-labelledby="address-tab">
                    <div class="form-group">
                        ...
                        <div class="form-group row">
                            <label class="col-12 col-sm-3 col-form-label text-sm-right">Dirección de Facturación</label>
                            <div class="col-sm-4 col-lg-3 mb-3 mb-sm-0">
                                <input onclick="checkbilling()" name="BillingCheckboxAddress" id="BillingCheckboxAddress" type="checkbox" placeholder="Estado" class="form-check-input" 
                                    data-toggle="tooltip" data-placement="top" title="Estado">
                            </div>
                        </div>
                                ...
                                <input id="DataCedula" name="Data_Cedula" type="file" class="form-control no-validate-form" aria-label="file example" required>
                                    ...
                                    <div class="tab-pane fade" id="factur" role="tabpanel" aria-labelledby="factur-tab">
                                        ...
                                        <div class="card-title d-flex align-items-center">
                                            ...
                                            <h3> Datos fiscales de Facturacion</h3>

                                        </div>
                                        <hr/>
                                        <div class="row mb-3">
                                            <label for="validationCustom07" class="col-sm-3 col-form-label">Nombre (Emisor):</label>
                                            <div class="col-sm-9">
                                                <input placeholder="Nombre (Emisor)" class="form-control" name="BillingName" id="" />
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <label for="validationCustom07" class="col-sm-3 col-form-label">RFC (Receptor)</label>
                                            <div class="col-sm-9">
                                                <input placeholder="RFC VECJ880326 XXX" class="form-control" name="text" id="" />
                                            </div>
                                        </div>
                                        <div  class="row mb-3">
                                            <label for="validationCustom07"class="col-sm-3 col-lg-3 col-form-label">Persona fisica o moral</label>
                                            <div  class="col-sm-9 col-lg-3">
                                            <select name="BillingTypePerson" class="selectpicker show-tick show-menu-arrow form-control" aria-label="Default select example">
                                            ...
                                            <label class="col-sm-3 col-lg-3 col-form-label" style="text-align: right;">Uso de (CFDI)</label>
                                                <div  class="col-sm-9 col-lg-3">
                                        ...
                                        <div class="row mb-3">
                                            <label for="validationCustom07" class="col-sm-3 col-form-label">Tipo de Moneda</label>
                                            <div class="col-sm-9 col-lg-3">
                                            ...
                                            <label for="validationCustom07" class="col-sm-3 col-form-label" style="text-align: right;">Forma de Pago</label>
                                            <div class="col-sm-9 col-lg-3">
                                                <select class="selectpicker show-tick show-menu-arrow form-control" aria-label="Default select example">
                                        ...
                                        <div id="contentAddressBilling">
                                            <hr>
                                            <h3> Direccion de FacturacionN </h3>
                                            <br>
                                            <div class="row mb-3">
                                                <label for="validationCustom07" class="col-sm-3 col-form-label">Dirección</label>
                                                <div class="col-sm-9">
                                                    <input type="text" name="Billing_full_address" placeholder="Dirección completa (Calle, número, colonia)" class="form-control @error('full_address') is-invalid @enderror">
                                                    @error('full_address')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                            ...
                                            <div class="row mb-3">
                                                <label for="validationCustom07" class="col-sm-3 col-form-label">Ciudad</label>
                                                <div class="col-sm-4 col-lg-3 mb-3 mb-sm-0">
                                                    <input name="Billing_city" type="text" placeholder="Ciudad" class="form-control datetimepicker-input @error('city') is-invalid @enderror">
                                                    @error('city')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                                ...
                                                <label class="col-sm-3 col-form-label col-form-label text-sm-right mr-3">Código postal</label>
                                                <div class="col-sm-4 col-lg-2 mb-3 mb-sm-0">
                                                    <input name="Billing_postal_code" type="text" placeholder="Código postal" class="form-control datetimepicker-input @error('postal_code') is-invalid @enderror">
                                                    @error('postal_code')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                            ...
                                            <div class="row mb-3">
                                                <label for="validationCustom07" class="col-sm-3 col-form-label">Entidad</label>
                                                <div class="col-sm-4 col-lg-3 mb-3 mb-sm-0">
                                                    <input name="Billing_state" type="text" placeholder="Estado" class="form-control datetimepicker-input @error('state') is-invalid @enderror" 
                                                        data-toggle="tooltip" data-placement="top" title="Estado">
                                                    @error('state')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                ...
                                                <label class="col-sm-3 col-form-label col-form-label text-sm-right mr-3">pais</label>
                                                <div class="col-sm-4 col-lg-2 mb-3 mb-sm-0">
                                                    <input name="Billing_country" type="text" placeholder="País" class="form-control datetimepicker-input @error('country') is-invalid @enderror" 
                                                        data-toggle="tooltip" data-placement="top" title="País">
                                                    @error('country')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
...
<script>
        ...
        function checkbilling(){
            if($('#BillingCheckboxAddress').is(":checked")){
                $('#contentAddressBilling').attr("style", "display: none !important;")
                } else {
                $('#contentAddressBilling').attr("style", "display: block !important;")
             }
        }
