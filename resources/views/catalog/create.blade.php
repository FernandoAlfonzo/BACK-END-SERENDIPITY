...
<div class="row">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="page-header">
            <h2 class="pageheader-title">Agregar Catálogo</h2>
        </div>
    </div>
</div>
<div class="justify-content-center">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card m-0 justify-content-center">
            <div class="card-body">
                <form id="form" data-parsley-validate="" method="POST" action="{{ route('catalog.store') }}">
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-9 col-lg-10">
                            <input id="code" name="code" type="text" required data-parsley-type="text" placeholder="Código del catálogo" class="form-control">
                        </div>
                    </div>
