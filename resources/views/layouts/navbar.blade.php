        <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <a class="navbar-brand" href="{{ url('/') }}"><img src="{{ asset('assets/images/logo.png') }}" width="290" alt=""></a>
                ...
                <div class="collapse navbar-collapse " id="navbarSupportedContent">
                    ...
                    <?php 
              //              $business=DB::table('organizations')->where('id_parent','=', 1)->where('is_active', '=', 1)->get();
                    ?>
                    <div class="form-group row">
                {{--        <!-- <div class="col-12 col-sm-12">
                        <h6>Unidad de Negocio </h6>
                            <select id="unidBussines" name="unidBussines" class="form-control" required>
                                        <option value="">Selecciona una opción</option>
                                        @foreach($business as $item)
                                            @if($item->is_active != 0)
                                            <option value="{{ $item->id }}" {{ $item->id == 1 ? 'selected' : ''}}>{{ $item->name_business}}</option>
                                            @endif
                                        @endforeach
                            </select>
                        </div> -->--}}
                        ...
                        <li class="nav-item dropdown nav-user">
                            ...
                            <div class="dropdown-menu dropdown-menu-right nav-user-dropdown" aria-labelledby="navbarDropdownMenuLink2">
                                <div class="nav-user-info">
                                    ...
                                    <span class="status"></span><span class="ml-2"> @if(Auth::user()->status == 1) Activo @endif </span>
                                </div>
