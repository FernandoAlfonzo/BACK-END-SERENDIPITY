...
<div class="row">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="page-header">
            <h2 class="pageheader-title"> Reglas de pago </h2>
                ...
                <nav class="navbar navbar-expand-lg card-header">
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <button class="btn btn-outline-success my-2 my-sm-0" type="submit" 
                            onclick="location.href='{{ route('products.create') }}'">Nuevo Regla
                        </button>
                       {{-- <div class="ml-5">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="dd-nodrag btn-group ml-auto">
                                                <button class="btn btn-sm btn-outline-light" data-toggle="tooltip" data-placement="top" title="Editar" onclick="location.href='{{ route('products.edit',$product->id) }}'">
                                                    <i class="far fa-edit"></i>
                                                </button>
                                                <button class="btn btn-sm btn-outline-light" data-toggle="tooltip" data-placement="top" title="Eliminar" id="stsCollab{{ $product->id }}" onclick="return delet({{$product->id}}, event)">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <form id="validationformActive" action="{{ url('product/delete') }}" method="POST" data-parsley-validate="">
                    @csrf
