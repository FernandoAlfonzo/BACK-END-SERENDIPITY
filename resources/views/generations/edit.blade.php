...
<div class="row">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="page-header">
            <h2 class="pageheader-title"> Editar Generación {{ $generation->name }} {{-- de {{ $service->ServiceName }} --}} </h2>
...
<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
    <div class="tab-regular">
        ...
        <form id="validationform" action="{{ route('generations.update', $generation->id) }}" method="POST" enctype="multipart/form-data" data-parsley-validate="" novalidate="">
            @csrf
            @method('PUT')
                ...
                <div class="tab-pane fade show active" id="general" role="tabpanel" aria-labelledby="general-tab">            
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-12 col-sm-8 col-lg-6">
                            <input type="text" name="name" value="{{ $generation->name }}" placeholder="Nombre de la generación" class="form-control @error('discount') is-invalid @enderror">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-12 col-sm-8 col-lg-6">
                            <textarea name="description" placeholder="Descripción de la generación" class="form-control @error('description') is-invalid @enderror">{{ $generation->description }}</textarea>
                            @error('description')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4 col-lg-2 mb-3 mb-sm-0">
                            <input type="text" name="code" value="{{ $generation->code }}" placeholder="Código de la generación" class="form-control @error('discount') is-invalid @enderror">
                        </div>

                        <label class="ol-sm-4 col-lg-2 mb-3 mb-sm-0 col-form-label text-sm-right">Clave</label>
                        <div class="col-sm-4 col-lg-2 mb-3 mb-sm-0">
                            <input type="text" name="long_code" value="{{ $generation->long_code }}" placeholder="Clave de la generación" class="form-control @error('discount') is-invalid @enderror">
                        </div>
                    </div>

                    {{-- <div class="form-group row">
                        <label class="col-12 col-sm-3 col-form-label text-sm-right">Descuento</label>
                        <div class="col-12 col-sm-8 col-lg-6">
                            <input type="text" name="discount" placeholder="Descuento o promoción que tendrá el servicio" class="form-control @error('discount') is-invalid @enderror">
                        </div>
                    </div> --}}
 ...
 --}}
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4 col-lg-3 mb-3 mb-sm-0">
                            <input id="start_at" name="start_at" value="{{ $generation->start_at }}" type="date" class="form-control datetimepicker-input @error('start_at') is-invalid @enderror" 
                        ...
                        <div class="col-sm-4 col-lg-3 mb-3 mb-sm-0">
                            <input id="finish_at" name="finish_at" type="date" value="{{ $generation->finish_at }}" class="form-control datetimepicker-input @error('finish_at') is-invalid @enderror" 
                                ...
                                <div class="col-sm-4 col-lg-4 mb-4 mb-sm-0 text-center">
                                    ...
                                    <div class="form-control bd-none">
                                        <div class="switch-button switch-button-success" data-toggle="tooltip" data-placement="right" title="{{ $rule->description }}">
                                            <input type="checkbox" value="{{ $rule->id }}" {{ $rule->is_private == 1 ? 'checked' : '' }}  name="payment_rules[]" id="pay-rules-{{ $rule->id }}"><span>
                ...
                <div class="tab-pane fade" id="sales" role="tabpanel" aria-labelledby="sales-tab">
                    <div class="form-group row justify-content-center">
                        @if (count($collaborators) > 0)
                            @foreach ($collaborators as $sale)
                                <div class="col-sm-4 col-lg-4 mb-4 mb-sm-0 text-center">
                                    <label class="col-form-label">{{ $sale->name . ' ' . $sale->lastNameF . ' ' . $sale->lastNameM }}</label>
                                    <div class="form-control bd-none">
                                        <div class="switch-button switch-button-success">
                                            <input type="checkbox" value="{{ $sale->idCollab }}" {{ $sale->is_private == 1 ? 'checked' : '' }}  name="salesmen[]" id="pay-rules-{{ $sale->idCollab }}"><span>
                ...
                <div class="tab-pane fade" id="modules" role="tabpanel" aria-labelledby="modules-tab">
                    <div class="" id="list_fields row">
                        <div id="field">
                            <div class="row modules">
                                <label class="col-12 col-sm-3 col-form-label text-sm-right">Módulos</label>
                                <div class="col-sm-4 col-lg-3 mb-3 mb-sm-0">
                                    <input id="start_at" name="modules[]" type="text" value="" placeholder="Nombre del módulo" class="form-control datetimepicker-input @error('modules') is-invalid @enderror">
                                    @error('modules')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4 col-lg-3 mb-3 mb-sm-0">
                                <button class="btn btn-outline-success" id="add_field" data-toggle="tooltip" data-placement="left" title="Agregar otro módulo">
                    ...
                    <div class="row"> 
                        ...
                        <div class="col-12 col-md-12 col-lg-12">
                            ...
                            @foreach ($profile_profesion as $profesion)
                                <option {{ $profesion->is_private == 1 ? 'selected' : '' }} value="{{ $profesion->id }}">{{$profesion->label}}</option>
                            @endforeach
                            </select>
                        </div>
                    </div> 
                ...
                // if (x < max_fields) {
                        $('#field').append('\
                         <div class="row modules">\
                                ...
                                <a href="#" class="remove_field text-right">Quitar</a>\
                            </div>');
                        x++;
                //}
        });
